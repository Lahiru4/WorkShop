...
public class MainDashBoardController {
    ...
    private void homeSet() throws IOException {
        Node resource = FXMLLoader.load(getClass().getResource("/view/DashBoardFrom.fxml"));
    ...
    public void onOrder(ActionEvent actionEvent) throws IOException {
        Node node=FXMLLoader.load(getClass().getResource("/view/Order_dashboard_form.fxml"));
        manDash.getChildren().clear();
    ...
    public void onCustomer(ActionEvent actionEvent) throws IOException {
        Node node = FXMLLoader.load(getClass().getResource("/view/CustromerManageFrom.fxml"));
